...
const CircuitWizardry = () => {
  const navigate = useNavigate();
  const [showComingSoon, setShowComingSoon] = useState(false);

  const googleFormsLink = "https://forms.gle/TAb5TsSbuqzjJbec8";
  ...
  const segment = {
    ...
    tagline: "Prove your circuit intuition under pressure — from analysis to debugging.",
    shortDescription: "Solve real-world inspired circuit challenges under time pressure. Perfect for those who love electronics, design thinking and troubleshooting.",
    detailedDescription: "Circuit Wizardry is a timed challenge where teams analyze schematics, identify faults, design sub-circuits and justify their choices. Problems are tuned around analog, digital and mixed-signal scenarios. This segment emphasizes fundamental EEE knowledge and practical reasoning, offering sponsors close association with deep technical skill and problem-solving ability.",
    highlights: [
...
export default CircuitWizardry;